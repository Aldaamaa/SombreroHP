...
respuestas = vector("character",dim(datos_pre)[1]) #Creamos vector para despues almacenar respuestas
respuestas[1:dim(datos_pre)[1]]=NA
i = 1;
while(i<=p){
...
#Cuadruplicamos la línea para rellenarlas para cada casa
#respuestas[2:4,] = respuestas[1,];
